    ...
    <section className="pb-16 lg:pb-24">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-between items-center mb-6 lg:mb-12">
          <h2
            className="text-center lg:text-left text-3xl md:text-4xl lg:text-5xl text-gray-900 font-playfairDisplay font-semibold"
            data-translate
          >
          ...
          <div className="hidden md:block">
            <Link href="/courses">
              <PrimaryButton label="View All Course" translate />
            </Link>
          </div>
        </div>
          ...
          {loading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 w-full">
              {courses.length > 0 ? (
                ...
                <div className="col-span-full text-center text-gray-500" data-translate>
                  No courses found
                </div>
              )}
            </div>
        ...
        <div className="mt-8 md:hidden">
          <Link href="/courses">
            <PrimaryButton label="View All Course" className="w-full" translate />
          </Link>
        </div>
      </div>
    </section>
