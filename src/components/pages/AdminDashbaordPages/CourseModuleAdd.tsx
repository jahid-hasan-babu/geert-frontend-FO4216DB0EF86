      ...
      if (file) {
        ...
        const interval = setInterval(() => {
          ...
          if (progress >= 100) {
            ...
            // Extract video duration after "upload" finishes
            ...
            videoEl.onloadedmetadata = () => {
              ...
              const formatted = new Date(durationInSeconds * 1000)
                .toISOString()
              ...
              console.log("[v0] Video duration:", formatted);
            };
                        ...
                        <TimePicker
                          value={
                            lesson.lessonDuration
                              ? dayjs(lesson.lessonDuration, "HH:mm:ss")
                              : null
                          }
                          format="HH:mm:ss"
                          onChange={(time) => {
                      ...
                      {lesson.lessonType === "video" && (
                        <div>
                          <input
                            ...
                            readOnly
                            className="w-full rounded-lg border bg-gray-100 px-3 py-1 text-gray-700 cursor-not-allowed"
                            placeholder="Duration will be set after upload"
                          />
                        </div>
                      )}
